...
- **System tray integration** — run in the background with idle, active, and paused tray icons
...
- **Recent sessions log** — sortable table with day, subject, duration, and notes
